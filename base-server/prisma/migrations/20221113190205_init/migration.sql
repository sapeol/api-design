...
-- AddForeignKey
ALTER TABLE "UpdatePoint" ADD CONSTRAINT "UpdatePoint_updatePointId_fkey" FOREIGN KEY ("updatePointId") REFERENCES "Update"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
